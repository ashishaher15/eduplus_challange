  ...
  const features = [
    {
      ...
      description:
        "Create and manage comprehensive company profiles with logo uploads, industry details, and complete business information.",
    },
    {
      icon: <FileText className="w-8 h-8" />,
      title: "Tender Management",
      description:
        "Create, publish, and manage tenders with detailed descriptions, deadlines, and budget specifications. Full CRUD operations available.",
    },
    {
      icon: <Search className="w-8 h-8" />,
      title: "Advanced Search",
      description:
        "Server-side search functionality to find companies by name, industry, or their products and services efficiently.",
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Application Workflow",
      description:
        "Streamlined process for companies to submit proposals against tenders with complete application tracking.",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Secure Authentication",
      description:
        "JWT-based authentication system with role-based access control for users, contractors, and administrators.",
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "B2B Platform",
      description:
        "Dedicated business-to-business platform connecting companies with tender opportunities across industries.",
    },
  ]

  const stats = [
    { number: "500+", label: "Active Companies" },
    { number: "1000+", label: "Published Tenders" },
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto animate-fade-in-up-delayed">
              The complete B2B platform for companies to create, publish, browse, and apply to tenders with advanced
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Powerful Features for Modern Business</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive tender management platform provides all the tools you need to streamline your business
              operations.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Transform Your Tender Management?</h2>
          <p className="text-xl mb-8 opacity-90">
            Join hundreds of companies already using TenderHub to streamline their business operations and discover new
            opportunities.
          </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                The comprehensive B2B tender management platform designed to connect businesses and streamline
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} TenderHub. All rights reserved.</p>
          </div>
        </div>
      </footer>
